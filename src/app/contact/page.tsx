            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:hello@invariantcontinuum.io" className="text-primary font-bold text-lg hover:underline">hello@invariantcontinuum.io</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="https://github.com/invariantcontinuum" className="text-primary font-bold text-lg hover:underline">github.com/invariantcontinuum</a>
                </div>
              </div>
