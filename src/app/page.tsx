    ...
    <div>
      <section className="hero">
        <div className="container">
          <h1 className="hero-title">Invariant Continuum</h1>
          <p className="hero-subtitle">
            Robust, formally verified software systems.
          </p>
          <div className="hero-actions">
            <Link href="https://github.com/invariantcontinuum" className="btn btn-primary">
              View on GitHub
            </Link>
          </div>
        </div>
          ...
          <div className="grid">
            <div className="card">
              ...
              <p className="card-desc">
                Foundational tools and libraries that power the invariantcontinuum ecosystem.
              </p>
            </div>
            <div className="card">
