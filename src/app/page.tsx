...
export default function Home() {
  ...
  const stats = [
    { value: "100+", label: "Proofs Verified" },
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <AnimatedSection className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 text-white leading-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-400 animate-gradient-shift">
                  {t.hero.title}
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <motion.a href="https://github.com/invariantcontinuum" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Button variant="contained" size="large" endIcon={<ArrowRight />} sx={{ px: 4, py: 2, fontSize: "1.1rem", boxShadow: "0 8px 32px #06B6D440" }}>
                    {t.hero.cta_github}
                  </Button>
                </motion.a>
      ...
      <section className="py-24 bg-white/5">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl font-bold mb-6 text-white">Prove It Works</h2>
            <p className="text-xl text-gray-400">From smart contracts to consensus algorithms, we verify before you deploy.</p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <AnimatedSection delay={0.2} className="flex-1 text-center lg:text-left order-1 lg:order-2">
              ...
              <h2 className="text-4xl font-bold mb-6 text-white">Mathematical Rigor for Decentralized Systems</h2>
              <p className="text-xl text-gray-400 leading-relaxed">invariant Continuum models protocols as state machines, proves safety and liveness properties, and generates executable code from verified specifications. Our proof assistants are used by blockchain developers and safety-critical engineers.</p>
            </AnimatedSection>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white/5">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection className="max-w-3xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-white">Don't Hope Your Code Is Correct. Prove It.</h2>
            <p className="text-xl text-gray-400 mb-10">Join researchers and engineers who refuse to ship unverified systems.</p>
            <motion.a href="https://github.com/invariantcontinuum" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
