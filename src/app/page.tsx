  ...
  return (
    <div>
      <AnimatedSection className="relative overflow-hidden flex items-center justify-center min-h-[80vh] bg-gray-900 text-white">
        <img 
          src="https://images.unsplash.com/photo-1516110833967-0b5716ca1387?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
          alt="Invariant Continuum Hero" 
        ...
        <div className="container mx-auto px-4 relative z-10 text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="https://github.com/invariantcontinuum" className="bg-primary text-white px-8 py-4 rounded-lg font-bold hover:bg-blue-600 transition-colors shadow-lg">
              View on GitHub
            </Link>
